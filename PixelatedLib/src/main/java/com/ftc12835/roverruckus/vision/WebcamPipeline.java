...
public abstract class WebcamPipeline {
    static {
        try {
    ...
    public void init(HardwareMap hardwareMap, ViewDisplay viewDisplay) {
    ...
    public void enable() {
        ...
        frameConsumerExecutor = ThreadPool.newSingleThreadExecutor("Webcam pipeline frame executor");
